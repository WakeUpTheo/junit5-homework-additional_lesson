...
public class HoverTests {
    ...
    // для selenide элементов в page objects проблем при параллельной работе не замечено - тесты не падали,
    // возможно всплывающая подсказка не очень удачный пример изменяемого объекта в shared memory.
